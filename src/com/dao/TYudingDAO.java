...
public class TYudingDAO extends HibernateDaoSupport
{
	...
	public static final String YUDING_SHUMU = "yudingShumu";

	public static final String YUDING_JINE = "yudingJine";

	public static final String YUDING_ZHUANTAI = "yudingZhuantai";
	...
	public List findByYudingShumu(Object yudingShumu)
	{
		return findByProperty(YUDING_SHUMU, yudingShumu);
	}

	public List findByYudingJine(Object yudingJine)
	{
		return findByProperty(YUDING_JINE, yudingJine);
	}

	public List findByYudingZhuantai(Object yudingZhuantai)
	{
		return findByProperty(YUDING_ZHUANTAI, yudingZhuantai);
	}
